...
class DBMSConfigFactoryLinux(DBMSConfigFactory):
  def __init__(self):
    ...
    self.DBMS_LIST = [
      ...
      DBMSDesc(self.DBMS_KEYS_LIST[1], STORAGE_TYPE_REMOTE, 'MySQL / MariaDB', '', createMySQLConfig),
      DBMSDesc(self.DBMS_KEYS_LIST[2], STORAGE_TYPE_REMOTE, 'Oracle', '', createOracleConfig),
    ...
    self.DBMS_DICT = \
    {
      ...
      self.DBMS_KEYS_LIST[1] + '-': 2,
      self.DBMS_KEYS_LIST[1] + '-' + STORAGE_TYPE_REMOTE: 2,
      self.DBMS_KEYS_LIST[4] + '-': 4,
      self.DBMS_KEYS_LIST[4] + '-' + STORAGE_TYPE_REMOTE: 4,
      self.DBMS_KEYS_LIST[2] + '-': 1,
      self.DBMS_KEYS_LIST[2] + '-' + STORAGE_TYPE_REMOTE: 1,
